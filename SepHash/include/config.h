...
struct Config
{
    ...
    void ParseArg(int argc, char *argv[])
    {
        ...
        cmd_parser.add<std::string>("ycsb_load", 't', "ycsb_load", false);
        cmd_parser.add<std::string>("ycsb_run", 'u', "ycsb_run", false);
        ...
        ycsb_load =  cmd_parser.get<std::string>("ycsb_load").c_str();
        ycsb_run = cmd_parser.get<std::string>("ycsb_run").c_str();
